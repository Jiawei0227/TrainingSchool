...
<div class="courses_banner">
    <div class="container">
        <h3>机构登录平台</h3>
        <p class="description">
            欢迎来到ELITE COLLEGE精英学校。这里是机构登录平台，这里有最权威的教育精英课程。一路精彩，等你启航。
        </p>
        <div class="breadcrumb1">
            <ul>
                <li class="icon6"><a href="/">主页</a></li>
                <li class="current-page">机构平台</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="courses_box1">
    <div class="container">
        <form class="login" method="post" action="/organization-Login">
            <p class="lead">欢迎回来！</p>
            <div class="form-group">
                <input autocomplete="new-password" type="text" name="username" class="required form-control" placeholder="机构卡号">
            </div>
            <div class="form-group">
            ...
            <p>还没有账号? <a href="/organization/organizationRegister" title="Sign Up">注册</a></p>
        </form>
    </div>
</div>
