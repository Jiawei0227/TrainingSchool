    ...
    <div class="container">
        ...
        <div class="breadcrumb1">
            <ul>
                ...
                <li class="icon6"><a href="/managerPlatform/studentList">学员列表</a></li>
                <li class="current-page">学员选课列表</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12">
            <div class="course_list">
                <div class="table-header clearfix">
                    ...
                    <div class="price_col"  style="width: 13%;">课程价格</div>
                    <div class="price_col"  style="width: 13%;">任课教师</div>
                ...
                <ul class="table-list">
                    ...
                    <li class="clearfix">
                        ...
                        <div class="price_col"  style="width: 13%;"><%=c.price %></div>

                        <div class="price_col" style="width: 13%;"><%=c.teacher %></div>
